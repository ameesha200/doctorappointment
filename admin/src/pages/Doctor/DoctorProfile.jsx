...

{
  ...
  isEdit
  ?<button onClick={updateProfile} className='px-4 py-1 border border-primary test-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>save</button>
  :<button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-primary test-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>Edit</button>
